...
TEXT_FREE_BOX = "🆓 **Бесплатная упаковка**\n\nУкажите Ваш номер ИНН или договора, а также почту или мобильный телефон и мы передадим запрос менеджеру."
...
TEXT_FINANCE_QUESTION = "❓ **Вопрос по счету**\n\nУкажите в сообщении Ваш ИНН или номер договора, номер счета, а также контактный телефон, а также напишите интересующий вопрос. Мы передадим информацию менеджеру."
TEXT_FINANCE_PERIOD = (
    "📝 Укажите период (ДД.ММ.ГГГГ - ДД.ММ.ГГГГ), ваш ИНН или номер договора одним сообщением."
)

TEXT_NEED_HELP_DATE_DELIVERY = (
    "📝 Укажите **номер заказа**, а также **ИНН или номер договора** одним сообщением."
)
...
def _order_edit():
    ...
    rows = [
        [packaging_paid.btn_cb("✅ Вопрос решен", "tracking_solved_yes")],
