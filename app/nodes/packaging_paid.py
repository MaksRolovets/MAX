...
CATALOG = {
    ...
    "Внутр. обрешетка": [
        {"id": "grid_1", "name": "Обрешетка «до 20кг»", "price": 890},
        {"id": "grid_2", "name": "Обрешетка «до 30кг»", "price": 1225},
        {"id": "grid_3", "name": "Обрешетка «XL»", "price": 825},
        {"id": "grid_4", "name": "Обрешетка «L»", "price": 495},
        {"id": "grid_5", "name": "Обрешетка «M»", "price": 130},
        {"id": "grid_6", "name": "Обрешетка «S»", "price": 65},
        {"id": "grid_7", "name": "Обрешетка «XXL»", "price": 1300},
    ],
    "Возд-пузырч. пленка": [
        {"id": "bubble_1", "name": "Возд-пузырч. пленка", "price": 90},
        {"id": "bubble_2", "name": "Возд-пузырч. пленка мини-рулон", "price": 265},
    ],
    "Конверты": [
    ...
    "Подарочные коробки": [
        {"id": "gift_1", "name": "Подарочная M (5кг 33х25х15)", "price": 220},
        {"id": "gift_2", "name": "Подарочная S (2кг 23х19х10)", "price": 195},
        {"id": "gift_3", "name": "Праздничная (25х21х10)", "price": 150},
        {"id": "gift_4", "name": "Праздничная M (5кг 33х25х15)", "price": 190},
    ],
    "Коробки": [
    ...
    "Мешки и пленки": [
        {"id": "bag_1", "name": "Крафт пакет 32х35", "price": 35},
        {"id": "bag_2", "name": "Лист. гофрокартон 0,8х1,2м", "price": 130},
        {"id": "bag_3", "name": "Мешок ламинир. до 100кг", "price": 195},
        {"id": "bag_4", "name": "Мешок ламинир. до 25кг", "price": 80},
        {"id": "bag_5", "name": "Мешок ламинир. до 50кг", "price": 105},
        {"id": "bag_6", "name": "Мешок ламинир. до 70кг", "price": 145},
    ],
    "Надувная пленка": [
        {"id": "air_1", "name": "Надувная пленка 30см х 50м", "price": 55},
        {"id": "air_2", "name": "Надувная пленка 40см х 50м", "price": 70},
        {"id": "air_3", "name": "Надувная пленка 50см х 50м", "price": 80},
    ],
    "Пакеты": [
